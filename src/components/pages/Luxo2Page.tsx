  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full flex-1 overflow-hidden">
        {/* Background Image */}
        <Image
          src="https://static.wixstatic.com/media/50f4bf_03a27466f234427aafff8800b539c304~mv2.png?originWidth=1920&originHeight=1024"
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              >
                Comprar por R${luxo2Price.toFixed(2)}
              </motion.button>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="font-paragraph text-white text-lg">
                          Bem-vindo ao Luxo 2, {playerName || 'Jogador'}!
                        </p>
                      </motion.div>
                    </motion.div>
                  )}
