...
export default function Luxo8Page() {
  ...
  const { backgroundImage } = useBackgroundImage('luxo8');

  const luxo8Price = 2302.60;
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              >
                Comprar por R${luxo8Price.toFixed(2)}
              </motion.button>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="font-paragraph text-white text-lg">
                          Bem-vindo ao Luxo 8, {playerName || 'Jogador'}!
                        </p>
                      </motion.div>
                    </motion.div>
                  )}
