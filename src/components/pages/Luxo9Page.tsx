...
export default function Luxo9Page() {
  ...
  const { backgroundImageundImageundImageage } = useBackgroundImageconst { backgroundImage } = useBackgroundImage('Luxo 4');
  (backgroundImageundImageundImage);
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              >
                Comprar por R${luxo9Price.toFixed(2)}
              </motion.button>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="font-paragraph text-white text-lg">
                          Bem-vindo ao Luxo 9, {playerName || 'Jogador'}!
                        </p>
                      </motion.div>
                    </motion.div>
                  )}
