...
interface CentroComunitario3DProps {
  scene: THREE.Scene;
...
export const CentroComunitario3D = ({
  scene,
  position,
  size,
  onClickCallback,
  ...
  useEffect(() => {
    ...
    gltfLoader.load(
      ...
      (gltf) => {
        ...
        group.add(model);
        group.userData = { clickable: true, type: 'centro-comunitario' };
        scene.add(group);
...
export default CentroComunitario3D;
